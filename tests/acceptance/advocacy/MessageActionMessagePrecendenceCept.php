...
$I->click("//input[normalize-space(@value)='Save configuration']]");
...
$I->fillField('#edit-combine', 'Barack');
$I->wait(3);
$I->click('Search');
$I->waitForElement('tr.views-row-first', 15);
$I->wait(5);
...
$I->waitForElement('#edit-submit-targets', 10);
$I->click('#edit-submit-targets');
$I->seeNumberOfElements('.views-table tr', [0,100]);
$I->wait(5);
$I->waitForElement('#advo-add-all', 10);
$I->click('#advo-add-all');
$I->waitForElement('.target-recipient',10);
$I->see('Group Target');
$I->see('Targeting: 1 group');
