...
class P2pAdminPage
{
    ...
    public function __construct(AcceptanceTester $I)
    {
      ...
      //add category fields
      $this->catDesc = '//textarea[@name="body[und][0][value]"]';
      $this->catTitle = '//input[@name="title"]';
      $this->catBanner='//input[@name="files[field_p2p_campaign_banner_und_0]"]';
      ...
      $this->catVid = '//input[@name="field_p2p_video_embed[und][0][video_url]"]';
      $this->catVidEdit = '//input[@name="field_p2p_video_embed_edit[und]"]';
