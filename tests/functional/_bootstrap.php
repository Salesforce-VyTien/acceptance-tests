...
define('FUNCTIONAL_TEST_DIRECTORY', dirname(__FILE__));
...
if (file_exists(FUNCTIONAL_TEST_DIRECTORY . '/_bootstrap_dev.php')) {
  require_once FUNCTIONAL_TEST_DIRECTORY . '/_bootstrap_dev.php';
}
